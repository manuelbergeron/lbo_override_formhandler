 ...
 * @package     Tx_Override_Formhandler
 */
...
if (TYPO3_MODE === 'BE') {
        ...
        // dynamic flexform
        include_once(t3lib_extMgm::extPath($_EXTKEY) . '/class.tx_override.php');
...
//      $TCA['tt_content']['types']['list']['subtypes_addlist'][$_EXTKEY . '_pi1'] = 'pi_flexform';
        ...
        $file = 'FILE:EXT:' . $_EXTKEY . '/flexform_ds.xml';

        // Add flexform DataStructure
        t3lib_extMgm::addPiFlexFormValue('formhandler_pi1', $file);
